...
Route::middleware(['auth', 'isDisabled'])->group(function () {
    ...
    Route::middleware('isManager')->group(function () {
        ...
        Route::get('dashboard/manager/credit-loads', [App\Http\Controllers\Dashboard\ManagerDashboardController::class, 'displayMaxCreditLoads'])->name('dashboard.manager.credit-loads');
    ...
    Route::resource('credit_loads', App\Http\Controllers\API\SemesterMaxCreditLoadAPIController::class);

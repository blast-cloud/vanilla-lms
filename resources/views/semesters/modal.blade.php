    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <i><small class="" style="color:red;">NOTE: Creating or Updating a semester will not affect the
                        current semester until the newly created semester is started.</small></i>
            </div>

            <div class="modal-body">
                <div id="div-semester-modal-error" class="alert alert-danger" role="alert"></div>
                <form class="form-horizontal" id="frm-semester-modal" role="form" method="POST"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn-save-mdl-semester-modal"
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    if (result.errors) {
                                        ...
                                        swal("Done!",
                                            "The Semester record has been deleted!",
                                            "success");
                    ...
                    success: function(result) {
                        if (result.errors) {
                            ...
                            window.setTimeout(function() {
                                swal("Done!", "The Semester record " + reports +

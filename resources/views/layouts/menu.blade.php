...
<li class="nav-item">
    <a href="{{ route('courseClasses.index') }}"
       class="nav-link {{ Request::is('courseClasses*') ? 'active' : '' }}">
        <p>Course Classes</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('classMaterials.index') }}"
       class="nav-link {{ Request::is('classMaterials*') ? 'active' : '' }}">
        <p>Class Materials</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('calendarEntries.index') }}"
       class="nav-link {{ Request::is('calendarEntries*') ? 'active' : '' }}">
...
<li class="nav-item">
    <a href="{{ route('lecturers.index') }}"
       class="nav-link {{ Request::is('lecturers*') ? 'active' : '' }}">
        <p>Lecturers</p>
    </a>
</li>
